...
namespace Microsoft.AspNetCore.Routing
{
    ...
    public static class LinkGeneratorEndpointNameAddressExtensions
    {
        ...
        /// <remarks>
        /// <para>
        /// <see cref="ParsePathByEndpointName(LinkGenerator, string, PathString)"/> will attempt to first resolve
            ...
            PathString path)
        {
            ...
            return generator.ParsePathByAddress<string>(endpointName, path);
        }
    }
}
